  ...
  return (
    <label>
      ...
      <select
        ...
        className={"w-full p-2 rounded-lg border-2 text-text dark:text-darkText bg-bg dark:bg-darkBg border-text dark:border-darkText focus:outline-none focus:border-primary dark:focus:border-primary".concat(
          " ",
          className || ""
        )}
        {...rest}
