...
export const Switch = ({ name, label, className }: Props) => {
  ...
  return (
    <label className={"flex items-center cursor-pointer".concat(" ", className || "")}>
      ...
      <div
        className={`relative w-11 h-6 peer-focus:ring-1 peer-focus:ring-primary dark:peer-focus:ring-primary
         ...
         after:transition-all  dark:peer-checked:bg-primary peer-checked:bg-primary`}
      />
